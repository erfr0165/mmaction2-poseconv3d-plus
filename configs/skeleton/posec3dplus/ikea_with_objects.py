...
dimensions = 16
embedding_path = '/data/embeddings/ikea_16dimensions.pkl'
...
ann_file_train = '/data/ikea_skel_origin_rcnn_obj_swint_all_cams_thres_0.1_and_objscore_v1_train.pkl'
ann_file_val = '/data/ikea_skel_origin_rcnn_obj_swint_all_cams_thres_0.1_and_objscore_v1_test.pkl'
left_kp = []
right_kp = []
train_pipeline = [
